        ...
        <nav
            ...
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                    ...
                    <a href="/dashboard" class="cursor-pointer flex items-center justify-between mr-4">
                        <img class="w-10 h-10" :src="'/images/Logo_PNG.png'">
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Unistock</span>
                    </a>
