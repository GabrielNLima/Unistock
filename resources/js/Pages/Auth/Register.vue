                        ...
                        <form @submit.prevent="create()" class="space-y-4 md:space-y-6">
                            <div>
                                ...
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ID</label>
                                    ...
                                    placeholder="ID"/>
                                    <div v-if="form.errors.idUsuario" class="mt-2 text-danger" v-text="form.errors.idUsuario"></div>
                            </div>
                            <div>
                                <label for="password"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Senha</label>
                                    ...
                                    class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
                                    <div v-if="form.errors.password" class="mt-2 text-danger" v-text="form.errors.password"></div>
                            </div>
